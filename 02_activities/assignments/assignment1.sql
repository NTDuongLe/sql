...
-- option 2 (to eliminate duplicate vendor_id column when there is only 1 common column between 2 tables)
SELECT *
FROM vendor
...
SELECT vba.vendor_id, vendor_name, count(vba.vendor_id) as booth_rental_count
...
--Query 1: Clear in case temp table new_vendor alr exist
DROP TABLE IF EXISTS new_vendor;

--Query 2: Create temp table new_vendor
CREATE TEMP TABLE new_vendor AS
SELECT * FROM vendor;

--Query 3: Insert new row for new 10th vendor 
